/**
 * 1.for POST ==> you have to mention method
 ...
 * 5.in the headers object mention content-type and the value will be
 * application/json to inform the server that you are sending json data
 ...
 * req body te backen er data pawa jabe
 */